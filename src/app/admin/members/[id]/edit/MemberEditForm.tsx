    ...
    <form action={action} encType="multipart/form-data" className="space-y-6">
      <Card className="p-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-2xl bg-saffron-100 text-4xl">
            {member.photoUrl ? (
          ...
          <Field label="नई फोटो अपलोड करें" hint="JPG/PNG/WEBP, अधिकतम 2 MB — खाली छोड़ने पर पुरानी फोटो रहेगी">
            <input name="photo" type="file" accept="image/jpeg,image/png,image/webp,image/gif" className={inputClass} />
          </Field>
        </div>
      </Card>
