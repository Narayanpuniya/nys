...
export default async function DonationSuccessPage({
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <p className="mt-2 text-stone-500">
          आपका भुगतान सत्यापित नहीं हो सका। कृपया संपर्क करें।
        </p>
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 text-center">
      ...
      {/* Status badge */}
      <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-amber-300 bg-amber-50 px-4 py-2 text-sm font-semibold text-amber-800">
      ...
      <Card className="mt-6 p-6 text-left">
        ...
        <div className="mt-4 rounded-xl border border-blue-100 bg-blue-50 p-3 text-xs text-blue-700">
          ...
          <p className="mt-1">
            ...
            किसी भी सहायता के लिए रसीद संख्या <strong>{donation.receiptNumber}</strong> बताएँ।
          </p>
        </div>
      </Card>

      {/* Contact */}
      <div className="mt-4 rounded-xl border border-stone-200 bg-stone-50 p-4 text-left text-sm">
